 ...
 *
 * @providesModule ViewabilityHelper_E44
 * @flow
 */
'use strict';
...
class ViewabilityHelper_E44 {
  ...
  constructor(config: ViewabilityConfig = {viewAreaCoveragePercentThreshold: 70}) {
    this._config = config;
  }
...
module.exports = ViewabilityHelper_E44;
