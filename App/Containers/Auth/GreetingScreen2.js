      ...
      return (
        [
          <View key='1' style={{width: windowSize.width, alignItems: 'center'}}>
            <SignInScreen scrollViewHandler={this.refs.scrollview} lostPassword={this.lostPassword.bind(this)} />
          </View>,
      ...
      return (
        [
          ...
          <View key='5' style={{width: windowSize.width, alignItems: 'center'}}>
            <SignUpNicknameScreen scrollViewHandler={this.refs.scrollview} lostPassword={this.lostPassword.bind(this)} />
          </View>
        ]
      )
    }
